...
from callcut.utils._checks import ensure_verbose
from callcut.utils._fixes import WrapStdOut
...
function :func:`callcut.set_log_level` or by the ``verbose`` argument of callables
decorated with the :func:`callcut.utils.logs.verbose` decorator.

Examples
--------
.. code-block:: python

    from callcut.utils.logs import logger, set_log_level
